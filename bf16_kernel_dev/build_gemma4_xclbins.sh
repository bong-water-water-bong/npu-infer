#!/bin/bash
# Build INT8 xclbins for Gemma4-E2B (H=1536, NH=16, NKV=2, HD=256, IM=6144)
set -e
...
# Gemma4-E2B dimensions:
# QKV:  A[128,1536] × W[1536, 4096+512+512] = A[128,5120]
# O:    A[128,4096] × W[4096, 1536] = A[128,1536]
# GU:   A[128,1536] × W[1536, 12288] = A[128,12288]  (combined, 2×IM=12288 ≤ 14336)
# D:    A[128,6144] × W[6144, 1536] = A[128,1536]

BUILD QKV 128 1536 5120
BUILD O   128 4096 1536
BUILD GU  128 1536 12288
BUILD D   128 6144 1536

echo "=== All Gemma4-E2B INT8 xclbins ==="
