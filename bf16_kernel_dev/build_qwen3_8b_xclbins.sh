#!/bin/bash
# Build INT8 xclbins for Qwen3-8B (H=4096, NH=32, NKV=8, HD=128, IM=12288)
set -e
...
# G:   A[128,4096] × W[4096, 12288] = A[128,12288]
# U:   A[128,4096] × W[4096, 12288] = A[128,12288]
# D:   A[128,12288] × W[12288, 4096] = A[128,4096]

BUILD QKV 128 4096 6144
BUILD O   128 4096 4096
BUILD G   128 4096 12288
BUILD U   128 4096 12288
BUILD D   128 12288 4096

echo "=== All Qwen3-8B INT8 xclbins ==="
