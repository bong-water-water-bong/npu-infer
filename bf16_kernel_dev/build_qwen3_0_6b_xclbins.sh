#!/bin/bash
# Build INT8 xclbins for Qwen3-0.6B (H=1024, NH=16, NKV=8, HD=128, IM=3072)
set -e
...
# Qwen3-0.6B dimensions (HD=128 tile)
# QKV: A[128,1024] × W[1024, 2048+1024+1024] = A[128,4096]
# O:   A[128,2048] × W[2048, 1024] = A[128,1024]
# GU:  A[128,1024] × W[1024, 6144] = A[128,6144] (combined, 2×IM=6144 ≤ 14336)
# D:   A[128,3072] × W[3072, 1024] = A[128,1024]
...
echo "=== All Qwen3-0.6B INT8 xclbins ==="
