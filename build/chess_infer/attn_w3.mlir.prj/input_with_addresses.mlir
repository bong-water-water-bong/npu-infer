module {
  aie.device(npu2) {
    ...
    %att_q = aie.buffer(%tile_0_2) {address = 35840 : i32, sym_name = "att_q"} : memref<256xi32> 
    %att_k0 = aie.buffer(%tile_0_2) {address = 1024 : i32, sym_name = "att_k0"} : memref<2048xi32> 
    %att_k1 = aie.buffer(%tile_0_2) {address = 9216 : i32, sym_name = "att_k1"} : memref<2048xi32> 
    %att_v0 = aie.buffer(%tile_0_2) {address = 17408 : i32, sym_name = "att_v0"} : memref<2048xi32> 
    %att_v1 = aie.buffer(%tile_0_2) {address = 25600 : i32, sym_name = "att_v1"} : memref<2048xi32> 
    %att_carrier = aie.buffer(%tile_0_2) {address = 37888 : i32, sym_name = "att_carrier"} : memref<40xi32> 
    %att_accum = aie.buffer(%tile_0_2) {address = 33792 : i32, sym_name = "att_accum"} : memref<512xi32> 
    %att_state = aie.buffer(%tile_0_2) {address = 38048 : i32, sym_name = "att_state"} : memref<8xi32> 
    %att_output = aie.buffer(%tile_0_2) {address = 36864 : i32, sym_name = "att_output"} : memref<256xi32> 
    ...
    %core_0_2 = aie.core(%tile_0_2) {
      ...
      func.call @qwen3_attention_bf16_init_accum(%att_accum, %att_state, %c512_i32, %c8_i32) : (memref<512xi32>, memref<8xi32>, i32, i32) -> ()
      func.call @qwen3_attention_bf16_make_carrier_masked(%att_q, %att_k0, %att_carrier, %c3_i32, %c3_i32, %c2_i32, %c7_i32, %c256_i32, %c2048_i32, %c40_i32) : (memref<256xi32>, memref<2048xi32>, memref<40xi32>, i32, i32, i32, i32, i32, i32, i32) -> ()
      func.call @qwen3_attention_bf16_accum_block(%att_v0, %att_carrier, %att_accum, %att_state, %c3_i32, %c2048_i32, %c40_i32, %c512_i32, %c8_i32) : (memref<2048xi32>, memref<40xi32>, memref<512xi32>, memref<8xi32>, i32, i32, i32, i32, i32) -> ()
      func.call @qwen3_attention_bf16_make_carrier_masked(%att_q, %att_k1, %att_carrier, %c3_i32, %c1_i32, %c2_i32, %c7_i32, %c256_i32, %c2048_i32, %c40_i32) : (memref<256xi32>, memref<2048xi32>, memref<40xi32>, i32, i32, i32, i32, i32, i32, i32) -> ()
      func.call @qwen3_attention_bf16_accum_block(%att_v1, %att_carrier, %att_accum, %att_state, %c1_i32, %c2048_i32, %c40_i32, %c512_i32, %c8_i32) : (memref<2048xi32>, memref<40xi32>, memref<512xi32>, memref<8xi32>, i32, i32, i32, i32, i32) -> ()
      aie.use_lock(%att_output_empty, AcquireGreaterEqual, 1)
      func.call @qwen3_attention_bf16_finish_accum(%att_accum, %att_state, %att_output, %c256_i32, %c512_i32, %c8_i32) : (memref<512xi32>, memref<8xi32>, memref<256xi32>, i32, i32, i32) -> ()
      aie.use_lock(%att_output_full, Release, 1)
      aie.use_lock(%att_input_empty, Release, 5)
      aie.end
    } {link_files = ["edge_attention_06b.o"]}
    ...
    ^bb7:  // 2 preds: ^bb6, ^bb7
      ...
      aie.dma_bd(%att_output : memref<256xi32>, 0, 256) {bd_id = 5 : i32, next_bd_id = 5 : i32}
      aie.use_lock(%att_output_empty, Release, 1)
      aie.next_bd ^bb7
    ^bb8:  // pred: ^bb6
      aie.end
    }
    aie.runtime_sequence(%arg0: memref<8448xi32>, %arg1: memref<256xi32>) {
