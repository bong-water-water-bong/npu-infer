...
define void @core_0_2() addrspace(0) {
  ...
  call addrspace(0) void @qwen3_attention_bf16_make_carrier_masked(ptr @att_q, ptr @att_k0, ptr @att_carrier, i32 1, i32 1, i32 2, i32 7, i32 256, i32 2048, i32 40)
  call addrspace(0) void @qwen3_attention_bf16_accum_block(ptr @att_v0, ptr @att_carrier, ptr @att_accum, ptr @att_state, i32 1, i32 2048, i32 40, i32 512, i32 8)
  call addrspace(0) void @qwen3_attention_bf16_make_carrier_masked(ptr @att_q, ptr @att_k1, ptr @att_carrier, i32 1, i32 1, i32 2, i32 7, i32 256, i32 2048, i32 40)
