module {
  aie.device(npu2) {
    ...
    ^bb4:  // 2 preds: ^bb3, ^bb5
      ...
      aie.dma_bd(%A_L3L2_0_cons_buff_0 : memref<128x512xi8>, 0, 65536, [<size = 32, stride = 2048>, <size = 64, stride = 1>, <size = 32, stride = 64>, <size = 1, stride = 1>]) {bd_id = 2 : i32, next_bd_id = 3 : i32}
      aie.use_lock(%A_L3L2_0_cons_prod_lock_0, Release, 1)
      aie.next_bd ^bb5
    ^bb5:  // pred: ^bb4
      aie.use_lock(%A_L3L2_0_cons_cons_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%A_L3L2_0_cons_buff_1 : memref<128x512xi8>, 0, 65536, [<size = 32, stride = 2048>, <size = 64, stride = 1>, <size = 32, stride = 64>, <size = 1, stride = 1>]) {bd_id = 3 : i32, next_bd_id = 2 : i32}
      aie.use_lock(%A_L3L2_0_cons_prod_lock_0, Release, 1)
      aie.next_bd ^bb4
    ^bb6:  // pred: ^bb3
    ...
    ^bb15:  // 2 preds: ^bb14, ^bb15
      ...
      aie.dma_bd(%C_L1L2_0_0_cons_buff_0 : memref<128x128xi16>, 0, 16384, [<size = 128, stride = 128>, <size = 1, stride = 1>, <size = 128, stride = 1>, <size = 1, stride = 1>]) {bd_id = 5 : i32, next_bd_id = 5 : i32}
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb2
      ...
      aie.dma_bd(%A_L2L1_0_0_cons_buff_0 : memref<32x64xi8>, 0, 2048, [<size = 64, stride = 1>, <size = 32, stride = 64>, <size = 1, stride = 1>]) {bd_id = 0 : i32, next_bd_id = 1 : i32}
      aie.use_lock(%A_L2L1_0_0_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb2
    ^bb2:  // pred: ^bb1
      aie.use_lock(%A_L2L1_0_0_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%A_L2L1_0_0_cons_buff_1 : memref<32x64xi8>, 0, 2048, [<size = 64, stride = 1>, <size = 32, stride = 64>, <size = 1, stride = 1>]) {bd_id = 1 : i32, next_bd_id = 0 : i32}
      aie.use_lock(%A_L2L1_0_0_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb1
    ^bb3:  // pred: ^bb0
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb2
      ...
      aie.dma_bd(%A_L2L1_0_1_cons_buff_0 : memref<32x64xi8>, 0, 2048, [<size = 64, stride = 1>, <size = 32, stride = 64>, <size = 1, stride = 1>]) {bd_id = 0 : i32, next_bd_id = 1 : i32}
      aie.use_lock(%A_L2L1_0_1_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb2
    ^bb2:  // pred: ^bb1
      aie.use_lock(%A_L2L1_0_1_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%A_L2L1_0_1_cons_buff_1 : memref<32x64xi8>, 0, 2048, [<size = 64, stride = 1>, <size = 32, stride = 64>, <size = 1, stride = 1>]) {bd_id = 1 : i32, next_bd_id = 0 : i32}
      aie.use_lock(%A_L2L1_0_1_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb1
    ^bb3:  // pred: ^bb0
      %1 = aie.dma_start(S2MM, 1, ^bb4, ^bb6)
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb2
      ...
      aie.dma_bd(%A_L2L1_0_2_cons_buff_0 : memref<32x64xi8>, 0, 2048, [<size = 64, stride = 1>, <size = 32, stride = 64>, <size = 1, stride = 1>]) {bd_id = 0 : i32, next_bd_id = 1 : i32}
      aie.use_lock(%A_L2L1_0_2_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb2
    ^bb2:  // pred: ^bb1
      aie.use_lock(%A_L2L1_0_2_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%A_L2L1_0_2_cons_buff_1 : memref<32x64xi8>, 0, 2048, [<size = 64, stride = 1>, <size = 32, stride = 64>, <size = 1, stride = 1>]) {bd_id = 1 : i32, next_bd_id = 0 : i32}
      aie.use_lock(%A_L2L1_0_2_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb1
    ^bb3:  // pred: ^bb0
      %1 = aie.dma_start(S2MM, 1, ^bb4, ^bb6)
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb2
      ...
      aie.dma_bd(%A_L2L1_0_3_cons_buff_0 : memref<32x64xi8>, 0, 2048, [<size = 64, stride = 1>, <size = 32, stride = 64>, <size = 1, stride = 1>]) {bd_id = 0 : i32, next_bd_id = 1 : i32}
      aie.use_lock(%A_L2L1_0_3_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb2
    ^bb2:  // pred: ^bb1
      aie.use_lock(%A_L2L1_0_3_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%A_L2L1_0_3_cons_buff_1 : memref<32x64xi8>, 0, 2048, [<size = 64, stride = 1>, <size = 32, stride = 64>, <size = 1, stride = 1>]) {bd_id = 1 : i32, next_bd_id = 0 : i32}
      aie.use_lock(%A_L2L1_0_3_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb1
    ^bb3:  // pred: ^bb0
      %1 = aie.dma_start(S2MM, 1, ^bb4, ^bb6)
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb2
      ...
      aie.dma_bd(%A_L2L1_0_4_cons_buff_0 : memref<32x64xi8>, 0, 2048, [<size = 64, stride = 1>, <size = 32, stride = 64>, <size = 1, stride = 1>]) {bd_id = 0 : i32, next_bd_id = 1 : i32}
      aie.use_lock(%A_L2L1_0_4_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb2
    ^bb2:  // pred: ^bb1
      aie.use_lock(%A_L2L1_0_4_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%A_L2L1_0_4_cons_buff_1 : memref<32x64xi8>, 0, 2048, [<size = 64, stride = 1>, <size = 32, stride = 64>, <size = 1, stride = 1>]) {bd_id = 1 : i32, next_bd_id = 0 : i32}
      aie.use_lock(%A_L2L1_0_4_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb1
    ^bb3:  // pred: ^bb0
      %1 = aie.dma_start(S2MM, 1, ^bb4, ^bb6)
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb2
      ...
      aie.dma_bd(%A_L2L1_0_5_cons_buff_0 : memref<32x64xi8>, 0, 2048, [<size = 64, stride = 1>, <size = 32, stride = 64>, <size = 1, stride = 1>]) {bd_id = 0 : i32, next_bd_id = 1 : i32}
      aie.use_lock(%A_L2L1_0_5_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb2
    ^bb2:  // pred: ^bb1
      aie.use_lock(%A_L2L1_0_5_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%A_L2L1_0_5_cons_buff_1 : memref<32x64xi8>, 0, 2048, [<size = 64, stride = 1>, <size = 32, stride = 64>, <size = 1, stride = 1>]) {bd_id = 1 : i32, next_bd_id = 0 : i32}
      aie.use_lock(%A_L2L1_0_5_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb1
    ^bb3:  // pred: ^bb0
      %1 = aie.dma_start(S2MM, 1, ^bb4, ^bb6)
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb2
      ...
      aie.dma_bd(%A_L2L1_0_6_cons_buff_0 : memref<32x64xi8>, 0, 2048, [<size = 64, stride = 1>, <size = 32, stride = 64>, <size = 1, stride = 1>]) {bd_id = 0 : i32, next_bd_id = 1 : i32}
      aie.use_lock(%A_L2L1_0_6_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb2
    ^bb2:  // pred: ^bb1
      aie.use_lock(%A_L2L1_0_6_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%A_L2L1_0_6_cons_buff_1 : memref<32x64xi8>, 0, 2048, [<size = 64, stride = 1>, <size = 32, stride = 64>, <size = 1, stride = 1>]) {bd_id = 1 : i32, next_bd_id = 0 : i32}
      aie.use_lock(%A_L2L1_0_6_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb1
    ^bb3:  // pred: ^bb0
      %1 = aie.dma_start(S2MM, 1, ^bb4, ^bb6)
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb2
      ...
      aie.dma_bd(%A_L2L1_0_7_cons_buff_0 : memref<32x64xi8>, 0, 2048, [<size = 64, stride = 1>, <size = 32, stride = 64>, <size = 1, stride = 1>]) {bd_id = 0 : i32, next_bd_id = 1 : i32}
      aie.use_lock(%A_L2L1_0_7_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb2
    ^bb2:  // pred: ^bb1
      aie.use_lock(%A_L2L1_0_7_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%A_L2L1_0_7_cons_buff_1 : memref<32x64xi8>, 0, 2048, [<size = 64, stride = 1>, <size = 32, stride = 64>, <size = 1, stride = 1>]) {bd_id = 1 : i32, next_bd_id = 0 : i32}
      aie.use_lock(%A_L2L1_0_7_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb1
    ^bb3:  // pred: ^bb0
      %1 = aie.dma_start(S2MM, 1, ^bb4, ^bb6)
    ...
    ^bb9:  // 2 preds: ^bb8, ^bb9
      ...
      aie.dma_bd(%C_L1L2_1_0_cons_buff_0 : memref<128x128xi16>, 0, 16384, [<size = 128, stride = 128>, <size = 1, stride = 1>, <size = 128, stride = 1>, <size = 1, stride = 1>]) {bd_id = 25 : i32, next_bd_id = 25 : i32}
    ...
    ^bb9:  // 2 preds: ^bb8, ^bb9
      ...
      aie.dma_bd(%C_L1L2_2_0_cons_buff_0 : memref<128x128xi16>, 0, 16384, [<size = 128, stride = 128>, <size = 1, stride = 1>, <size = 128, stride = 1>, <size = 1, stride = 1>]) {bd_id = 25 : i32, next_bd_id = 25 : i32}
    ...
    ^bb9:  // 2 preds: ^bb8, ^bb9
      ...
      aie.dma_bd(%C_L1L2_3_0_cons_buff_0 : memref<128x128xi16>, 0, 16384, [<size = 128, stride = 128>, <size = 1, stride = 1>, <size = 128, stride = 1>, <size = 1, stride = 1>]) {bd_id = 25 : i32, next_bd_id = 25 : i32}
    ...
    ^bb9:  // 2 preds: ^bb8, ^bb9
      ...
      aie.dma_bd(%C_L1L2_4_0_cons_buff_0 : memref<128x128xi16>, 0, 16384, [<size = 128, stride = 128>, <size = 1, stride = 1>, <size = 128, stride = 1>, <size = 1, stride = 1>]) {bd_id = 25 : i32, next_bd_id = 25 : i32}
    ...
    ^bb9:  // 2 preds: ^bb8, ^bb9
      ...
      aie.dma_bd(%C_L1L2_5_0_cons_buff_0 : memref<128x128xi16>, 0, 16384, [<size = 128, stride = 128>, <size = 1, stride = 1>, <size = 128, stride = 1>, <size = 1, stride = 1>]) {bd_id = 25 : i32, next_bd_id = 25 : i32}
    ...
    ^bb9:  // 2 preds: ^bb8, ^bb9
      ...
      aie.dma_bd(%C_L1L2_6_0_cons_buff_0 : memref<128x128xi16>, 0, 16384, [<size = 128, stride = 128>, <size = 1, stride = 1>, <size = 128, stride = 1>, <size = 1, stride = 1>]) {bd_id = 25 : i32, next_bd_id = 25 : i32}
    ...
    ^bb9:  // 2 preds: ^bb8, ^bb9
      ...
      aie.dma_bd(%C_L1L2_7_0_cons_buff_0 : memref<128x128xi16>, 0, 16384, [<size = 128, stride = 128>, <size = 1, stride = 1>, <size = 128, stride = 1>, <size = 1, stride = 1>]) {bd_id = 25 : i32, next_bd_id = 25 : i32}
