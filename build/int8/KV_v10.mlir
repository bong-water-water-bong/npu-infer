module {
  aie.device(npu2) {
    ...
    aie.objectfifo @AS0(%shim_noc_tile_0_0, {%mem_tile_0_1}, 1 : i32) : !aie.objectfifo<memref<32x128xi8>> 
    aie.objectfifo @AC0(%mem_tile_0_1, {%tile_0_2}, 1 : i32) : !aie.objectfifo<memref<32x64xi8>> 
    ...
    aie.objectfifo @AS1(%shim_noc_tile_0_0, {%mem_tile_1_1}, 1 : i32) : !aie.objectfifo<memref<32x128xi8>> 
    aie.objectfifo @AC1(%mem_tile_1_1, {%tile_1_2}, 1 : i32) : !aie.objectfifo<memref<32x64xi8>> 
    ...
    aie.objectfifo @AS2(%shim_noc_tile_0_0, {%mem_tile_2_1}, 1 : i32) : !aie.objectfifo<memref<32x128xi8>> 
    aie.objectfifo @AC2(%mem_tile_2_1, {%tile_2_2}, 1 : i32) : !aie.objectfifo<memref<32x64xi8>> 
    ...
    aie.objectfifo @AS3(%shim_noc_tile_0_0, {%mem_tile_3_1}, 1 : i32) : !aie.objectfifo<memref<32x128xi8>> 
    aie.objectfifo @AC3(%mem_tile_3_1, {%tile_3_2}, 1 : i32) : !aie.objectfifo<memref<32x64xi8>> 
    ...
    aie.objectfifo @AS4(%shim_noc_tile_0_0, {%mem_tile_4_1}, 1 : i32) : !aie.objectfifo<memref<32x128xi8>> 
    aie.objectfifo @AC4(%mem_tile_4_1, {%tile_4_2}, 1 : i32) : !aie.objectfifo<memref<32x64xi8>> 
    ...
    aie.objectfifo @AS5(%shim_noc_tile_0_0, {%mem_tile_5_1}, 1 : i32) : !aie.objectfifo<memref<32x128xi8>> 
    aie.objectfifo @AC5(%mem_tile_5_1, {%tile_5_2}, 1 : i32) : !aie.objectfifo<memref<32x64xi8>> 
    ...
    aie.objectfifo @AS6(%shim_noc_tile_0_0, {%mem_tile_6_1}, 1 : i32) : !aie.objectfifo<memref<32x128xi8>> 
    aie.objectfifo @AC6(%mem_tile_6_1, {%tile_6_2}, 1 : i32) : !aie.objectfifo<memref<32x64xi8>> 
    ...
    aie.objectfifo @AS7(%shim_noc_tile_0_0, {%mem_tile_7_1}, 1 : i32) : !aie.objectfifo<memref<32x128xi8>> 
    aie.objectfifo @AC7(%mem_tile_7_1, {%tile_7_2}, 1 : i32) : !aie.objectfifo<memref<32x64xi8>> 
    ...
    aie.runtime_sequence @seq(%arg0: memref<131072xi8>, %arg1: memref<1048576xi8>, %arg2: memref<131072xi16>) {
      %0 = aiex.dma_configure_task_for @AS0 {
        aie.dma_bd(%arg0 : memref<131072xi8>, 0, 32768, [<size = 1, stride = 0>, <size = 8, stride = 128>, <size = 32, stride = 1024>, <size = 128, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      }
      ...
      %24 = aiex.dma_configure_task_for @AS0 {
        aie.dma_bd(%arg0 : memref<131072xi8>, 32768, 32768, [<size = 1, stride = 0>, <size = 8, stride = 128>, <size = 32, stride = 1024>, <size = 128, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      }
      ...
      %48 = aiex.dma_configure_task_for @AS0 {
        aie.dma_bd(%arg0 : memref<131072xi8>, 65536, 32768, [<size = 1, stride = 0>, <size = 8, stride = 128>, <size = 32, stride = 1024>, <size = 128, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      }
      ...
      %72 = aiex.dma_configure_task_for @AS0 {
        aie.dma_bd(%arg0 : memref<131072xi8>, 98304, 32768, [<size = 1, stride = 0>, <size = 8, stride = 128>, <size = 32, stride = 1024>, <size = 128, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      }
