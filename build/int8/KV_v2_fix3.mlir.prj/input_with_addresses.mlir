module {
  aie.device(npu2) {
    ...
    ^bb4:  // 2 preds: ^bb3, ^bb5
      ...
      aie.dma_bd(%A_L3L2_0_cons_buff_0 : memref<32x512xi8>, 0, 16384, [<size = 32, stride = 64>, <size = 512, stride = 1>]) {bd_id = 2 : i32, next_bd_id = 3 : i32}
      aie.use_lock(%A_L3L2_0_cons_prod_lock_0, Release, 1)
      aie.next_bd ^bb5
    ^bb5:  // pred: ^bb4
      aie.use_lock(%A_L3L2_0_cons_cons_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%A_L3L2_0_cons_buff_1 : memref<32x512xi8>, 0, 16384, [<size = 32, stride = 64>, <size = 512, stride = 1>]) {bd_id = 3 : i32, next_bd_id = 2 : i32}
      aie.use_lock(%A_L3L2_0_cons_prod_lock_0, Release, 1)
      aie.next_bd ^bb4
    ^bb6:  // pred: ^bb3
