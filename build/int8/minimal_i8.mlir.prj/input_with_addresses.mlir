module {
  aie.device(npu2) {
    ...
    %core_0_2 = aie.core(%tile_0_2) {
      aie.use_lock(%c_c_prod_lock_0, AcquireGreaterEqual, 1)
      func.call @zero_i16(%c_c_buff_0) : (memref<32x128xi16>) -> ()
      aie.use_lock(%a_c_cons_cons_lock_0, AcquireGreaterEqual, 1)
      aie.use_lock(%b_c_cons_cons_lock_0, AcquireGreaterEqual, 1)
      func.call @matmul_i8_i16(%a_c_cons_buff_0, %b_c_cons_buff_0, %c_c_buff_0) : (memref<32x64xi8>, memref<64x128xi8>, memref<32x128xi16>) -> ()
      aie.use_lock(%a_c_cons_prod_lock_0, Release, 1)
      aie.use_lock(%b_c_cons_prod_lock_0, Release, 1)
      aie.use_lock(%c_c_cons_lock_0, Release, 1)
      aie.end
