module {
  aie.device(npu2) {
    ...
    aie.objectfifo @A_L2L1(%mem_tile_0_1 dimensionsToStream [<size = 8, stride = 2048>, <size = 32, stride = 64>], {%tile_0_2 dimensionsFromStream [<size = 32, stride = 64>], %tile_1_2 dimensionsFromStream [<size = 32, stride = 64>], %tile_2_2 dimensionsFromStream [<size = 32, stride = 64>], %tile_3_2 dimensionsFromStream [<size = 32, stride = 64>], %tile_4_2 dimensionsFromStream [<size = 32, stride = 64>], %tile_5_2 dimensionsFromStream [<size = 32, stride = 64>], %tile_6_2 dimensionsFromStream [<size = 32, stride = 64>], %tile_7_2 dimensionsFromStream [<size = 32, stride = 64>]}, 2 : i32) : !aie.objectfifo<memref<32x64xi8>> 
