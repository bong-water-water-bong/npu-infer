module {
  aie.device(npu2) {
    ...
    aie.objectfifo @A_L3L2(%shim_noc_tile_0_0, {%mem_tile_0_1 dimensionsFromStream [<size = 128, stride = 64>, <size = 8, stride = 8192>, <size = 64, stride = 1>]}, 2 : i32) : !aie.objectfifo<memref<128x512xi8>> 
    aie.objectfifo @A_L2L1(%mem_tile_0_1 dimensionsToStream [<size = 8, stride = 2048>, <size = 32, stride = 64>], {%tile_0_2 dimensionsFromStream [<size = 8, stride = 64>, <size = 32, stride = 2048>, <size = 64, stride = 1>], %tile_1_2 dimensionsFromStream [<size = 8, stride = 64>, <size = 32, stride = 2048>, <size = 64, stride = 1>], %tile_2_2 dimensionsFromStream [<size = 8, stride = 64>, <size = 32, stride = 2048>, <size = 64, stride = 1>], %tile_3_2 dimensionsFromStream [<size = 8, stride = 64>, <size = 32, stride = 2048>, <size = 64, stride = 1>], %tile_4_2 dimensionsFromStream [<size = 8, stride = 64>, <size = 32, stride = 2048>, <size = 64, stride = 1>], %tile_5_2 dimensionsFromStream [<size = 8, stride = 64>, <size = 32, stride = 2048>, <size = 64, stride = 1>], %tile_6_2 dimensionsFromStream [<size = 8, stride = 64>, <size = 32, stride = 2048>, <size = 64, stride = 1>], %tile_7_2 dimensionsFromStream [<size = 8, stride = 64>, <size = 32, stride = 2048>, <size = 64, stride = 1>]}, 2 : i32) : !aie.objectfifo<memref<32x64xi8>> 
