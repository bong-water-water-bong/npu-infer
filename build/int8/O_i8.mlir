  ...
  aie.device(npu2) {
    ...
    %core_0_2 = aie.core(%tile_0_2) {
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c32 step %c1_1 {
          ...
          func.call @matmul_i8_i16(%5, %3, %1) : (memref<32x64xi8>, memref<64x128xi8>, memref<128x128xi16>) -> ()
          ...
          func.call @matmul_i8_i16(%7, %3, %1) : (memref<32x64xi8>, memref<64x128xi8>, memref<128x128xi16>) -> ()
          aie.objectfifo.release @A_L2L1_0(Consume, 1)
          ...
          func.call @matmul_i8_i16(%9, %3, %1) : (memref<32x64xi8>, memref<64x128xi8>, memref<128x128xi16>) -> ()
          aie.objectfifo.release @A_L2L1_0(Consume, 1)
          ...
          func.call @matmul_i8_i16(%11, %3, %1) : (memref<32x64xi8>, memref<64x128xi8>, memref<128x128xi16>) -> ()
          aie.objectfifo.release @A_L2L1_0(Consume, 1)
    ...
    aie.runtime_sequence(%arg0: memref<262144xi8>, %arg1: memref<2097152xi8>, %arg2: memref<131072xi16>) {
      %0 = aiex.dma_configure_task_for @A_L3L2_0 {
        aie.dma_bd(%arg0 : memref<262144xi8>, 0, 262144, [<size = 1, stride = 0>, <size = 4, stride = 512>, <size = 128, stride = 2048>, <size = 512, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      }
