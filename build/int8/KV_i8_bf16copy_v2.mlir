module {
  aie.device(npu2) {
    ...
    aie.objectfifo @A_L2L1_0(%mem_tile_0_1 dimensionsToStream [<size = 32, stride = 2048>, <size = 64, stride = 1>, <size = 32, stride = 64>, <size = 1, stride = 1>], {%tile_0_2 dimensionsFromStream [<size = 64, stride = 1>, <size = 32, stride = 64>, <size = 1, stride = 1>], %tile_1_2 dimensionsFromStream [<size = 64, stride = 1>, <size = 32, stride = 64>, <size = 1, stride = 1>], %tile_2_2 dimensionsFromStream [<size = 64, stride = 1>, <size = 32, stride = 64>, <size = 1, stride = 1>], %tile_3_2 dimensionsFromStream [<size = 64, stride = 1>, <size = 32, stride = 64>, <size = 1, stride = 1>], %tile_4_2 dimensionsFromStream [<size = 64, stride = 1>, <size = 32, stride = 64>, <size = 1, stride = 1>], %tile_5_2 dimensionsFromStream [<size = 64, stride = 1>, <size = 32, stride = 64>, <size = 1, stride = 1>], %tile_6_2 dimensionsFromStream [<size = 64, stride = 1>, <size = 32, stride = 64>, <size = 1, stride = 1>], %tile_7_2 dimensionsFromStream [<size = 64, stride = 1>, <size = 32, stride = 64>, <size = 1, stride = 1>]}, 2 : i32) : !aie.objectfifo<memref<32x64xi8>> 
    ...
    aie.objectfifo @C_L2L3_0(%mem_tile_0_1 dimensionsToStream [<size = 128, stride = 128>, <size = 1, stride = 1>, <size = 128, stride = 1>, <size = 1, stride = 1>], {%shim_noc_tile_0_0}, 2 : i32) : !aie.objectfifo<memref<128x128xi16>> 
    ...
    aie.objectfifo @C_L2L3_1(%mem_tile_1_1 dimensionsToStream [<size = 128, stride = 128>, <size = 1, stride = 1>, <size = 128, stride = 1>, <size = 1, stride = 1>], {%shim_noc_tile_1_0}, 2 : i32) : !aie.objectfifo<memref<128x128xi16>> 
    ...
    aie.objectfifo @C_L2L3_2(%mem_tile_2_1 dimensionsToStream [<size = 128, stride = 128>, <size = 1, stride = 1>, <size = 128, stride = 1>, <size = 1, stride = 1>], {%shim_noc_tile_2_0}, 2 : i32) : !aie.objectfifo<memref<128x128xi16>> 
    ...
    aie.objectfifo @C_L2L3_3(%mem_tile_3_1 dimensionsToStream [<size = 128, stride = 128>, <size = 1, stride = 1>, <size = 128, stride = 1>, <size = 1, stride = 1>], {%shim_noc_tile_3_0}, 2 : i32) : !aie.objectfifo<memref<128x128xi16>> 
    ...
    aie.objectfifo @C_L2L3_4(%mem_tile_4_1 dimensionsToStream [<size = 128, stride = 128>, <size = 1, stride = 1>, <size = 128, stride = 1>, <size = 1, stride = 1>], {%shim_noc_tile_4_0}, 2 : i32) : !aie.objectfifo<memref<128x128xi16>> 
    ...
    aie.objectfifo @C_L2L3_5(%mem_tile_5_1 dimensionsToStream [<size = 128, stride = 128>, <size = 1, stride = 1>, <size = 128, stride = 1>, <size = 1, stride = 1>], {%shim_noc_tile_5_0}, 2 : i32) : !aie.objectfifo<memref<128x128xi16>> 
    ...
    aie.objectfifo @C_L2L3_6(%mem_tile_6_1 dimensionsToStream [<size = 128, stride = 128>, <size = 1, stride = 1>, <size = 128, stride = 1>, <size = 1, stride = 1>], {%shim_noc_tile_6_0}, 2 : i32) : !aie.objectfifo<memref<128x128xi16>> 
    ...
    aie.objectfifo @C_L2L3_7(%mem_tile_7_1 dimensionsToStream [<size = 128, stride = 128>, <size = 1, stride = 1>, <size = 128, stride = 1>, <size = 1, stride = 1>], {%shim_noc_tile_7_0}, 2 : i32) : !aie.objectfifo<memref<128x128xi16>> 
    ...
    %core_0_2 = aie.core(%tile_0_2) {
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c16 step %c1_1 {
          ...
          %6 = aie.objectfifo.acquire @A_L2L1_0(Consume, 1) : !aie.objectfifosubview<memref<32x64xi8>>
          %7 = aie.objectfifo.subview.access %6[0] : !aie.objectfifosubview<memref<32x64xi8>> -> memref<32x64xi8>
          func.call @matmul_scalar_i8_i16(%7, %3, %1) : (memref<32x64xi8>, memref<64x128xi8>, memref<128x128xi16>) -> ()
          aie.objectfifo.release @A_L2L1_0(Consume, 1)
          %8 = aie.objectfifo.acquire @A_L2L1_0(Consume, 1) : !aie.objectfifosubview<memref<32x64xi8>>
          %9 = aie.objectfifo.subview.access %8[0] : !aie.objectfifosubview<memref<32x64xi8>> -> memref<32x64xi8>
          func.call @matmul_scalar_i8_i16(%9, %3, %1) : (memref<32x64xi8>, memref<64x128xi8>, memref<128x128xi16>) -> ()
          aie.objectfifo.release @A_L2L1_0(Consume, 1)
          ...
          func.call @matmul_scalar_i8_i16(%11, %3, %1) : (memref<32x64xi8>, memref<64x128xi8>, memref<128x128xi16>) -> ()
          aie.objectfifo.release @A_L2L1_0(Consume, 1)
