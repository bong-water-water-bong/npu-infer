module {
  aie.device(npu2) {
    ...
    aie.objectfifo @AS1(%shim_noc_tile_1_0, {%mem_tile_1_1 dimensionsFromStream [<size = 32, stride = 64>, <size = 8, stride = 2048>, <size = 64, stride = 1>]}, 2 : i32) : !aie.objectfifo<memref<32x512xi8>> 
    ...
    aie.objectfifo @AS2(%shim_noc_tile_2_0, {%mem_tile_2_1 dimensionsFromStream [<size = 32, stride = 64>, <size = 8, stride = 2048>, <size = 64, stride = 1>]}, 2 : i32) : !aie.objectfifo<memref<32x512xi8>> 
    ...
    aie.objectfifo @AS3(%shim_noc_tile_3_0, {%mem_tile_3_1 dimensionsFromStream [<size = 32, stride = 64>, <size = 8, stride = 2048>, <size = 64, stride = 1>]}, 2 : i32) : !aie.objectfifo<memref<32x512xi8>> 
    ...
    aie.objectfifo @AS4(%shim_noc_tile_4_0, {%mem_tile_4_1 dimensionsFromStream [<size = 32, stride = 64>, <size = 8, stride = 2048>, <size = 64, stride = 1>]}, 2 : i32) : !aie.objectfifo<memref<32x512xi8>> 
    ...
    aie.objectfifo @AS5(%shim_noc_tile_5_0, {%mem_tile_5_1 dimensionsFromStream [<size = 32, stride = 64>, <size = 8, stride = 2048>, <size = 64, stride = 1>]}, 2 : i32) : !aie.objectfifo<memref<32x512xi8>> 
    ...
    aie.objectfifo @AS6(%shim_noc_tile_6_0, {%mem_tile_6_1 dimensionsFromStream [<size = 32, stride = 64>, <size = 8, stride = 2048>, <size = 64, stride = 1>]}, 2 : i32) : !aie.objectfifo<memref<32x512xi8>> 
    ...
    aie.objectfifo @AS7(%shim_noc_tile_7_0, {%mem_tile_7_1 dimensionsFromStream [<size = 32, stride = 64>, <size = 8, stride = 2048>, <size = 64, stride = 1>]}, 2 : i32) : !aie.objectfifo<memref<32x512xi8>> 
