module {
  aie.device(npu2) {
    ...
    aie.objectfifo @B_L3L2_0(%shim_noc_tile_0_0, {%mem_tile_0_1 dimensionsFromStream [<size = 64, stride = 128>, <size = 8, stride = 8192>, <size = 128, stride = 1>]}, 2 : i32) : !aie.objectfifo<memref<64x128xi8>> 
    aie.objectfifo @B_L2L1_0(%mem_tile_0_1, {%tile_0_2}, 2 : i32) : !aie.objectfifo<memref<64x128xi8>> 
    aie.objectfifo.link [@B_L3L2_0] -> [@B_L2L1_0]([] [])
    aie.objectfifo @B_L3L2_1(%shim_noc_tile_1_0, {%mem_tile_1_1 dimensionsFromStream [<size = 64, stride = 128>, <size = 8, stride = 8192>, <size = 128, stride = 1>]}, 2 : i32) : !aie.objectfifo<memref<64x128xi8>> 
    aie.objectfifo @B_L2L1_1(%mem_tile_1_1, {%tile_1_2}, 2 : i32) : !aie.objectfifo<memref<64x128xi8>> 
    aie.objectfifo.link [@B_L3L2_1] -> [@B_L2L1_1]([] [])
    aie.objectfifo @B_L3L2_2(%shim_noc_tile_2_0, {%mem_tile_2_1 dimensionsFromStream [<size = 64, stride = 128>, <size = 8, stride = 8192>, <size = 128, stride = 1>]}, 2 : i32) : !aie.objectfifo<memref<64x128xi8>> 
    aie.objectfifo @B_L2L1_2(%mem_tile_2_1, {%tile_2_2}, 2 : i32) : !aie.objectfifo<memref<64x128xi8>> 
    aie.objectfifo.link [@B_L3L2_2] -> [@B_L2L1_2]([] [])
    aie.objectfifo @B_L3L2_3(%shim_noc_tile_3_0, {%mem_tile_3_1 dimensionsFromStream [<size = 64, stride = 128>, <size = 8, stride = 8192>, <size = 128, stride = 1>]}, 2 : i32) : !aie.objectfifo<memref<64x128xi8>> 
    aie.objectfifo @B_L2L1_3(%mem_tile_3_1, {%tile_3_2}, 2 : i32) : !aie.objectfifo<memref<64x128xi8>> 
    aie.objectfifo.link [@B_L3L2_3] -> [@B_L2L1_3]([] [])
    aie.objectfifo @B_L3L2_4(%shim_noc_tile_4_0, {%mem_tile_4_1 dimensionsFromStream [<size = 64, stride = 128>, <size = 8, stride = 8192>, <size = 128, stride = 1>]}, 2 : i32) : !aie.objectfifo<memref<64x128xi8>> 
    aie.objectfifo @B_L2L1_4(%mem_tile_4_1, {%tile_4_2}, 2 : i32) : !aie.objectfifo<memref<64x128xi8>> 
    aie.objectfifo.link [@B_L3L2_4] -> [@B_L2L1_4]([] [])
    aie.objectfifo @B_L3L2_5(%shim_noc_tile_5_0, {%mem_tile_5_1 dimensionsFromStream [<size = 64, stride = 128>, <size = 8, stride = 8192>, <size = 128, stride = 1>]}, 2 : i32) : !aie.objectfifo<memref<64x128xi8>> 
    aie.objectfifo @B_L2L1_5(%mem_tile_5_1, {%tile_5_2}, 2 : i32) : !aie.objectfifo<memref<64x128xi8>> 
    aie.objectfifo.link [@B_L3L2_5] -> [@B_L2L1_5]([] [])
    aie.objectfifo @B_L3L2_6(%shim_noc_tile_6_0, {%mem_tile_6_1 dimensionsFromStream [<size = 64, stride = 128>, <size = 8, stride = 8192>, <size = 128, stride = 1>]}, 2 : i32) : !aie.objectfifo<memref<64x128xi8>> 
    aie.objectfifo @B_L2L1_6(%mem_tile_6_1, {%tile_6_2}, 2 : i32) : !aie.objectfifo<memref<64x128xi8>> 
    aie.objectfifo.link [@B_L3L2_6] -> [@B_L2L1_6]([] [])
    aie.objectfifo @B_L3L2_7(%shim_noc_tile_7_0, {%mem_tile_7_1 dimensionsFromStream [<size = 64, stride = 128>, <size = 8, stride = 8192>, <size = 128, stride = 1>]}, 2 : i32) : !aie.objectfifo<memref<64x128xi8>> 
    ...
    %core_0_2 = aie.core(%tile_0_2) {
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_2 to %c32_3 step %c1_4 {
          %8 = aie.objectfifo.acquire @B_L2L1_0(Consume, 1) : !aie.objectfifosubview<memref<64x128xi8>>
          %9 = aie.objectfifo.subview.access %8[0] : !aie.objectfifosubview<memref<64x128xi8>> -> memref<64x128xi8>
          %10 = aie.objectfifo.acquire @A_L2L1_0(Consume, 1) : !aie.objectfifosubview<memref<32x64xi8>>
          %11 = aie.objectfifo.subview.access %10[0] : !aie.objectfifosubview<memref<32x64xi8>> -> memref<32x64xi8>
        ...
        scf.for %arg1 = %c0_5 to %c32_6 step %c1_7 {
          %8 = aie.objectfifo.acquire @B_L2L1_0(Consume, 1) : !aie.objectfifosubview<memref<64x128xi8>>
          %9 = aie.objectfifo.subview.access %8[0] : !aie.objectfifosubview<memref<64x128xi8>> -> memref<64x128xi8>
          %10 = aie.objectfifo.acquire @A_L2L1_0(Consume, 1) : !aie.objectfifosubview<memref<32x64xi8>>
          %11 = aie.objectfifo.subview.access %10[0] : !aie.objectfifosubview<memref<32x64xi8>> -> memref<32x64xi8>
        ...
        scf.for %arg1 = %c0_8 to %c32_9 step %c1_10 {
          %8 = aie.objectfifo.acquire @B_L2L1_0(Consume, 1) : !aie.objectfifosubview<memref<64x128xi8>>
          %9 = aie.objectfifo.subview.access %8[0] : !aie.objectfifosubview<memref<64x128xi8>> -> memref<64x128xi8>
          %10 = aie.objectfifo.acquire @A_L2L1_0(Consume, 1) : !aie.objectfifosubview<memref<32x64xi8>>
          %11 = aie.objectfifo.subview.access %10[0] : !aie.objectfifosubview<memref<32x64xi8>> -> memref<32x64xi8>
    ...
    aie.runtime_sequence(%arg0: memref<262144xi8>, %arg1: memref<2097152xi8>, %arg2: memref<131072xi16>) {
      %0 = aiex.dma_configure_task_for @A_L3L2_0 {
        aie.dma_bd(%arg0 : memref<262144xi8>, 0, 65536, [<size = 1, stride = 0>, <size = 4, stride = 512>, <size = 32, stride = 2048>, <size = 512, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      }
      aiex.dma_start_task(%0)
      %1 = aiex.dma_configure_task_for @B_L3L2_0 {
        aie.dma_bd(%arg1 : memref<2097152xi8>, 0, 262144, [<size = 1, stride = 0>, <size = 1, stride = 0>, <size = 1, stride = 0>, <size = 262144, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      }
      aiex.dma_start_task(%1)
      %2 = aiex.dma_configure_task_for @B_L3L2_1 {
        aie.dma_bd(%arg1 : memref<2097152xi8>, 262144, 262144, [<size = 1, stride = 0>, <size = 1, stride = 0>, <size = 1, stride = 0>, <size = 262144, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      }
      aiex.dma_start_task(%2)
      %3 = aiex.dma_configure_task_for @B_L3L2_2 {
        aie.dma_bd(%arg1 : memref<2097152xi8>, 524288, 262144, [<size = 1, stride = 0>, <size = 1, stride = 0>, <size = 1, stride = 0>, <size = 262144, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      }
      aiex.dma_start_task(%3)
      %4 = aiex.dma_configure_task_for @B_L3L2_3 {
        aie.dma_bd(%arg1 : memref<2097152xi8>, 786432, 262144, [<size = 1, stride = 0>, <size = 1, stride = 0>, <size = 1, stride = 0>, <size = 262144, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      }
      aiex.dma_start_task(%4)
      %5 = aiex.dma_configure_task_for @B_L3L2_4 {
        aie.dma_bd(%arg1 : memref<2097152xi8>, 1048576, 262144, [<size = 1, stride = 0>, <size = 1, stride = 0>, <size = 1, stride = 0>, <size = 262144, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      }
      aiex.dma_start_task(%5)
      %6 = aiex.dma_configure_task_for @B_L3L2_5 {
        aie.dma_bd(%arg1 : memref<2097152xi8>, 1310720, 262144, [<size = 1, stride = 0>, <size = 1, stride = 0>, <size = 1, stride = 0>, <size = 262144, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      }
      aiex.dma_start_task(%6)
      %7 = aiex.dma_configure_task_for @B_L3L2_6 {
        aie.dma_bd(%arg1 : memref<2097152xi8>, 1572864, 262144, [<size = 1, stride = 0>, <size = 1, stride = 0>, <size = 1, stride = 0>, <size = 262144, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      }
      aiex.dma_start_task(%7)
      %8 = aiex.dma_configure_task_for @B_L3L2_7 {
        aie.dma_bd(%arg1 : memref<2097152xi8>, 1835008, 262144, [<size = 1, stride = 0>, <size = 1, stride = 0>, <size = 1, stride = 0>, <size = 262144, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      }
      ...
      %17 = aiex.dma_configure_task_for @A_L3L2_0 {
        aie.dma_bd(%arg0 : memref<262144xi8>, 65536, 65536, [<size = 1, stride = 0>, <size = 4, stride = 512>, <size = 32, stride = 2048>, <size = 512, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      }
      ...
      %34 = aiex.dma_configure_task_for @A_L3L2_0 {
        aie.dma_bd(%arg0 : memref<262144xi8>, 131072, 65536, [<size = 1, stride = 0>, <size = 4, stride = 512>, <size = 32, stride = 2048>, <size = 512, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      }
      ...
      %51 = aiex.dma_configure_task_for @A_L3L2_0 {
        aie.dma_bd(%arg0 : memref<262144xi8>, 196608, 65536, [<size = 1, stride = 0>, <size = 4, stride = 512>, <size = 32, stride = 2048>, <size = 512, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      }
