module {
  aie.device(npu2) {
    ...
    ^bb2:  // pred: ^bb1
      ...
      func.call @zero_kernel_bf16(%C_L1L2_0_0_buff_0) : (memref<128x128xi16>) -> ()
      cf.br ^bb3(%c0 : index)
    ...
    ^bb2:  // pred: ^bb1
      ...
      func.call @zero_kernel_bf16(%C_L1L2_1_0_buff_0) : (memref<128x128xi16>) -> ()
      cf.br ^bb3(%c0 : index)
    ^bb3(%2: index):  // 2 preds: ^bb2, ^bb24
      %3 = arith.cmpi slt, %2, %c16 : index
      cf.cond_br %3, ^bb4, ^bb25
    ...
    ^bb2:  // pred: ^bb1
      ...
      func.call @zero_kernel_bf16(%C_L1L2_2_0_buff_0) : (memref<128x128xi16>) -> ()
      cf.br ^bb3(%c0 : index)
    ^bb3(%2: index):  // 2 preds: ^bb2, ^bb24
      %3 = arith.cmpi slt, %2, %c16 : index
      cf.cond_br %3, ^bb4, ^bb25
    ...
    ^bb2:  // pred: ^bb1
      ...
      func.call @zero_kernel_bf16(%C_L1L2_3_0_buff_0) : (memref<128x128xi16>) -> ()
      cf.br ^bb3(%c0 : index)
    ^bb3(%2: index):  // 2 preds: ^bb2, ^bb24
      %3 = arith.cmpi slt, %2, %c16 : index
      cf.cond_br %3, ^bb4, ^bb25
    ...
    ^bb2:  // pred: ^bb1
      ...
      func.call @zero_kernel_bf16(%C_L1L2_4_0_buff_0) : (memref<128x128xi16>) -> ()
      cf.br ^bb3(%c0 : index)
    ^bb3(%2: index):  // 2 preds: ^bb2, ^bb24
      %3 = arith.cmpi slt, %2, %c16 : index
      cf.cond_br %3, ^bb4, ^bb25
    ...
    ^bb2:  // pred: ^bb1
      ...
      func.call @zero_kernel_bf16(%C_L1L2_5_0_buff_0) : (memref<128x128xi16>) -> ()
      cf.br ^bb3(%c0 : index)
    ^bb3(%2: index):  // 2 preds: ^bb2, ^bb24
      %3 = arith.cmpi slt, %2, %c16 : index
      cf.cond_br %3, ^bb4, ^bb25
    ...
    ^bb2:  // pred: ^bb1
      ...
      func.call @zero_kernel_bf16(%C_L1L2_6_0_buff_0) : (memref<128x128xi16>) -> ()
      cf.br ^bb3(%c0 : index)
    ^bb3(%2: index):  // 2 preds: ^bb2, ^bb24
      %3 = arith.cmpi slt, %2, %c16 : index
      cf.cond_br %3, ^bb4, ^bb25
    ...
    ^bb2:  // pred: ^bb1
      ...
      func.call @zero_kernel_bf16(%C_L1L2_7_0_buff_0) : (memref<128x128xi16>) -> ()
      cf.br ^bb3(%c0 : index)
    ^bb3(%2: index):  // 2 preds: ^bb2, ^bb24
      %3 = arith.cmpi slt, %2, %c16 : index
      cf.cond_br %3, ^bb4, ^bb25
