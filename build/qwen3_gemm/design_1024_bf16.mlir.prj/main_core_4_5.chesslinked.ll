...
11:                                               ; preds = %8
  ...
  call addrspace(0) void @matmul_vectorized_bf16(ptr @AL1_3_4_cons_buff_0, ptr @BL1_4_3_cons_buff_0, ptr @CL1_4_3_buff_0)
  call addrspace(0) void @llvm.aie2p.release(i32 48, i32 1)
  call addrspace(0) void @llvm.aie2p.acquire(i32 49, i32 -1)
  call addrspace(0) void @matmul_vectorized_bf16(ptr @AL1_3_4_cons_buff_1, ptr @BL1_4_3_cons_buff_0, ptr @CL1_4_3_buff_0)
  call addrspace(0) void @llvm.aie2p.release(i32 48, i32 1)
  call addrspace(0) void @llvm.aie2p.acquire(i32 49, i32 -1)
  call addrspace(0) void @matmul_vectorized_bf16(ptr @AL1_3_4_cons_buff_0, ptr @BL1_4_3_cons_buff_0, ptr @CL1_4_3_buff_0)
  call addrspace(0) void @llvm.aie2p.release(i32 48, i32 1)
