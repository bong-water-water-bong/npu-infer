module {
  aie.device(npu2) {
    ...
    aie.objectfifo @A_in(%shim_noc_tile_0_0, {%mem_tile_0_1}, 1 : i32) : !aie.objectfifo<memref<128x512xbf16>> 
    aie.objectfifo @A_l1(%mem_tile_0_1, {%tile_0_2}, 1 : i32) : !aie.objectfifo<memref<32x64xbf16>> 
    aie.objectfifo.link [@A_in] -> [@A_l1]([] [])
    aie.objectfifo @B_in(%shim_noc_tile_0_0, {%mem_tile_0_1}, 1 : i32) : !aie.objectfifo<memref<64x128xbf16>> 
    aie.objectfifo @B_l1(%mem_tile_0_1, {%tile_0_2}, 1 : i32) : !aie.objectfifo<memref<64x128xbf16>> 
