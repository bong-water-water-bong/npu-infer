...
11:                                               ; preds = %8
  ...
  call addrspace(0) void @matmul_vectorized_different_datatypes(ptr @AL1_1_5_cons_buff_0, ptr @BL1_5_1_cons_buff_0, ptr @CL1_5_1_buff_0)
  call addrspace(0) void @llvm.aie2p.release(i32 48, i32 1)
  call addrspace(0) void @llvm.aie2p.acquire(i32 49, i32 -1)
  call addrspace(0) void @matmul_vectorized_different_datatypes(ptr @AL1_1_5_cons_buff_1, ptr @BL1_5_1_cons_buff_0, ptr @CL1_5_1_buff_0)
  call addrspace(0) void @llvm.aie2p.release(i32 48, i32 1)
  call addrspace(0) void @llvm.aie2p.acquire(i32 49, i32 -1)
  call addrspace(0) void @matmul_vectorized_different_datatypes(ptr @AL1_1_5_cons_buff_0, ptr @BL1_5_1_cons_buff_0, ptr @CL1_5_1_buff_0)
  call addrspace(0) void @llvm.aie2p.release(i32 48, i32 1)
  ...
  call addrspace(0) void @llvm.aie2p.acquire(i32 51, i32 -1)
  call addrspace(0) void @llvm.aie2p.acquire(i32 49, i32 -1)
  call addrspace(0) void @matmul_vectorized_different_datatypes(ptr @AL1_1_5_cons_buff_0, ptr @BL1_5_1_cons_buff_1, ptr @CL1_5_1_buff_0)
  call addrspace(0) void @llvm.aie2p.release(i32 48, i32 1)
  call addrspace(0) void @llvm.aie2p.acquire(i32 49, i32 -1)
  call addrspace(0) void @matmul_vectorized_different_datatypes(ptr @AL1_1_5_cons_buff_1, ptr @BL1_5_1_cons_buff_1, ptr @CL1_5_1_buff_0)
  call addrspace(0) void @llvm.aie2p.release(i32 48, i32 1)
  call addrspace(0) void @llvm.aie2p.acquire(i32 49, i32 -1)
  call addrspace(0) void @matmul_vectorized_different_datatypes(ptr @AL1_1_5_cons_buff_0, ptr @BL1_5_1_cons_buff_1, ptr @CL1_5_1_buff_0)
  call addrspace(0) void @llvm.aie2p.release(i32 48, i32 1)
