...
7:                                                ; preds = %4
  ...
  call addrspace(0) void @zero_kernel_bf16(ptr @C_l1_buff_0)
  br label %8
...
11:                                               ; preds = %8
  ...
  call addrspace(0) void @matmul_vectorized_bf16(ptr @A_l1_cons_buff_0, ptr @B_l1_cons_buff_0, ptr @C_l1_buff_0)
